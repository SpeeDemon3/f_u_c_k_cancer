...
<body>
    ...
    <div id="page-container">
        ...
        <main class="container my-5">
            <h1 class="text-center mb-4 font-monospace" style="color:rgb(88, 34, 162);">Asociación Fuck Cancer</h1>
            ...
            <div class="web-asociacion-contenido text-center mx-auto" style="max-width: 800px; font-size: 1.1rem; line-height: 1.6;">
                <p>Esta asociación combate al cáncer.</p>
                <p><strong>Teléfono:</strong> 923456789</p>
                <p><strong>Sitio Web:</strong> <a href="https://www.contraelcancer.es/es" target="_blank">https://www.fuckcancer.es</a></p>
            </div>
