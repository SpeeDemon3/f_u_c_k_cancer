...
<body>
    ...
    <div id="page-container">
        ...
        <main class="container my-5">
            <h1 class="text-center mb-4 font-monospace" style="color:rgb(88, 34, 162);">AECC</h1>
            ...
            <div class="web-asociacion-contenido text-center mx-auto" style="max-width: 800px; font-size: 1.1rem; line-height: 1.6;">
                <p>La Fundación Jiménez Díaz contra el cáncer es una iniciativa dedicada a la investigación, prevención, diagnóstico y tratamiento del cáncer, vinculada al prestigioso Hospital Universitario Fundación Jiménez Díaz en Madrid, España.</p>
                <p><strong>Teléfono:</strong> 655776532</p>
                <p><strong>Sitio Web:</strong> <a href="https://www.fjd.es/" target="_blank">https://www.fjd.es/</a></p>
            </div>
