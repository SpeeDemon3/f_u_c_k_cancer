...
<body class="bg-light d-flex flex-column min-vh-100">
    ...
    <header class="text-black text-center py-5">
        <div class="container">
            <h1 class="fw-bold">Ejercicio Físico y Prevención del Cáncer</h1>
            <p class="lead">Mantenerse activo ayuda a reducir el riesgo de desarrollar cáncer y mejora la calidad de vida.</p>
        </div>
    </header>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="text-primary">Beneficios del ejercicio en la prevención del cáncer</h2>
    ...
    <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">Tipos de Ejercicio Recomendados</h2>
