        ...
        <div id="page-container">
            ...
            <main class="container my-5">
                ...
                <div class="text-center mb-4">
                    <img src="../../img/noticias/67b9e6108e630_extra-8.jpg" alt="Test 1 Noticia" class="web-noticia-imagen img-fluid web-noticia-imagen" style="max-width: 100%; height: auto; border-radius: 10px;">
                </div>
                <div class="web-noticia-contenido text-center mx-auto" style="max-width: 800px; font-size: 1.1rem; line-height: 1.6;">
                    <p>edsafdaasdsadsad</p>
                </div>
