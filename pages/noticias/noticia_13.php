...
<html lang="es">
    <head>
        ...
        <title>Noticia de un administrador</title>
    ...
    <body>
        ...
        <div id="page-container">
            ...
            <main class="container my-5">
                <h1 class="text-center mb-4 font-monospace"  style="color:rgb(88, 34, 162);">Noticia de un administrador</h1>
                <div class="text-center mb-4">
                    <img src="../../img/noticias/680b3997ee012_noticas-2.jpg" alt="Noticia de un administrador" class="web-noticia-imagen img-fluid web-noticia-imagen" style="max-width: 50%; height: auto; border-radius: 10px;">
                </div>
                <div class="web-noticia-contenido text-center mx-auto" style="max-width: 800px; font-size: 1.1rem; line-height: 1.6;">
                    <p>Noticia desde un usuario administrador</p>
                </div>
