    ...
    <body>
        ...
        <div id="page-container">
            ...
            <main class="container my-5">
                <h1 class="text-center mb-4">Test 1 Noticia2</h1>
                <div class="text-center mb-4">
                    <img src="../../img/noticias/67b9dc50b48aa_noticas-4.jpg" alt="Test 1 Noticia2" class="web-noticia-imagen img-fluid web-noticia-imagen" style="max-width: 100%; height: auto; border-radius: 10px;">
                </div>
                <div class="web-noticia-contenido text-center mx-auto" style="max-width: 800px; font-size: 1.1rem; line-height: 1.6;">
                    <p>Test 1 Noticia2Test 1 Noticia2</p>
                </div>
