    ...
    <body>
        ...
        <div id="page-container">
            ...
            <main class="container my-5">
                <h1 class="text-center mb-4">Test 1 Noticia</h1>
                <div class="text-center mb-4">
                    <img src="../../img/noticias/67cc8e08aa0c9_extra-4.jpg" alt="Test 1 Noticia" class="web-noticia-imagen img-fluid web-noticia-imagen" style="max-width: 100%; height: auto; border-radius: 10px;">
                </div>
                <div class="web-noticia-contenido text-center mx-auto" style="max-width: 800px; font-size: 1.1rem; line-height: 1.6;">
                    <p>dsafdsfdsafdsafdsfds</p>
                </div>
