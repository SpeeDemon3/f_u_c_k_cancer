        ...
        <div id="page-container">
            ...
            <main class="container my-5">
                ...
                <div class="text-center mb-4">
                    <img src="../../img/noticias/67b9e19df343a_medicos-2.jpg" alt="Test 1" class="web-noticia-imagen img-fluid web-noticia-imagen" style="max-width: 100%; height: auto; border-radius: 10px;">
                </div>
                <div class="web-noticia-contenido text-center mx-auto" style="max-width: 800px; font-size: 1.1rem; line-height: 1.6;">
                    <p>vfdgsdgfsgfdsgfdg</p>
                </div>
